 ...
 *********************************************************/
		...
		#elif GPT_CLK_PRESCALER_TIM0 == GPT_CLK_PRESCALAR_1
			SET_BIT(TCCR0,CS00);
			RESET_BIT(TCCR0,CS01);
			RESET_BIT(TCCR0,CS02);
		#elif GPT_CLK_PRESCALER_TIM0 == GPT_CLK_PRESCALAR_8
			RESET_BIT(TCCR0,CS00);
			SET_BIT(TCCR0,CS01);
			RESET_BIT(TCCR0,CS02);
			...
			SET_BIT(TCCR0,CS01);
			RESET_BIT(TCCR0,CS02);
		#elif GPT_CLK_PRESCALER_TIM0 == GPT_CLK_PRESCALAR_256
			RESET_BIT(TCCR0,CS00);
			RESET_BIT(TCCR0,CS01);
			SET_BIT(TCCR0,CS02);
		#elif GPT_CLK_PRESCALER_TIM0 == GPT_CLK_PRESCALAR_1024
			SET_BIT(TCCR0,CS00);
			RESET_BIT(TCCR0,CS01);
			SET_BIT(TCCR0,CS02);
		#elif GPT_CLK_PRESCALER_TIM0 == GPT_CLK_PRESCALAR_EXT_FALLING
			RESET_BIT(TCCR0,CS00);
			SET_BIT(TCCR0,CS01);
			SET_BIT(TCCR0,CS02);
		#elif GPT_CLK_PRESCALER_TIM0 == GPT_CLK_PRESCALAR_EXT_RISING
			SET_BIT(TCCR0,CS00);
			SET_BIT(TCCR0,CS01);
			SET_BIT(TCCR0,CS02);
		#else
 ...
 *********************************************************/
		...
		#elif GPT_CLK_PRESCALER_TIM1 == GPT_CLK_PRESCALAR_1
			SET_BIT(TCCR1B,CS10);
			RESET_BIT(TCCR1B,CS11);
			RESET_BIT(TCCR1B,CS12);
		#elif GPT_CLK_PRESCALER_TIM1 == GPT_CLK_PRESCALAR_8
			RESET_BIT(TCCR1B,CS10);
			SET_BIT(TCCR1B,CS11);
			RESET_BIT(TCCR1B,CS12);
			...
			SET_BIT(TCCR1B,CS11);
			RESET_BIT(TCCR1B,CS12);
		#elif GPT_CLK_PRESCALER_TIM1 == GPT_CLK_PRESCALAR_256
			RESET_BIT(TCCR1B,CS10);
			RESET_BIT(TCCR1B,CS11);
			SET_BIT(TCCR1B,CS12);
		#elif GPT_CLK_PRESCALER_TIM1 == GPT_CLK_PRESCALAR_1024
			SET_BIT(TCCR1B,CS10);
			RESET_BIT(TCCR1B,CS11);
			SET_BIT(TCCR1B,CS12);
		#elif GPT_CLK_PRESCALER_TIM1 == GPT_CLK_PRESCALAR_EXT_FALLING
			RESET_BIT(TCCR1B,CS10);
			SET_BIT(TCCR1B,CS11);
			SET_BIT(TCCR1B,CS12);
		#elif GPT_CLK_PRESCALER_TIM1 == GPT_CLK_PRESCALAR_EXT_RISING
			SET_BIT(TCCR1B,CS10);
			SET_BIT(TCCR1B,CS11);
			SET_BIT(TCCR1B,CS12);
		#else
 ...
 *********************************************************/
		...
		#elif GPT_CLK_PRESCALER_TIM2 == GPT_CLK_PRESCALAR_1
			SET_BIT(TCCR2,CS20);
			RESET_BIT(TCCR2,CS21);
			RESET_BIT(TCCR2,CS22);
		#elif GPT_CLK_PRESCALER_TIM2 == GPT_CLK_PRESCALAR_8
			RESET_BIT(TCCR2,CS20);
			SET_BIT(TCCR2,CS21);
			RESET_BIT(TCCR2,CS22);
			...
			RESET_BIT(TCCR2,CS21);
			SET_BIT(TCCR2,CS22);
		#elif GPT_CLK_PRESCALER_TIM2 == GPT_CLK_PRESCALAR_1024
			SET_BIT(TCCR2,CS20);
			RESET_BIT(TCCR2,CS21);
			SET_BIT(TCCR2,CS22);
		#elif GPT_CLK_PRESCALER_TIM2 == GPT_CLK_PRESCALAR_EXT_FALLING
			RESET_BIT(TCCR2,CS20);
			SET_BIT(TCCR2,CS21);
			SET_BIT(TCCR2,CS22);
		#elif GPT_CLK_PRESCALER_TIM2 == GPT_CLK_PRESCALAR_EXT_RISING
			SET_BIT(TCCR2,CS20);
			SET_BIT(TCCR2,CS21);
			SET_BIT(TCCR2,CS22);
		#else
